<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% boolean isLoggedIn=false; boolean isError=false; if ("POST".equalsIgnoreCase(request.getMethod())) { String
        user=request.getParameter("username"); String pass=request.getParameter("password"); if ("user123".equals(user)
        && "123456" .equals(pass)) { isLoggedIn=true; } else { isError=true; } } %>
        <!DOCTYPE html>
        <html>
            ...
            <% if (isLoggedIn) { %>
                ...
                <div class="card" style="border-color: #4ade80; box-shadow: 0 0 35px rgba(74, 222, 128, 0.2);">
                    ...
                    <div class="links-container">
                        <a href="https://apod.nasa.gov/apod/astropix.html" target="_blank" class="btn-link">🚀 View NASA
                ...
                <% } else { %>
                    ...
                    <div class="card <%= isError ? " shake" : "" %>">
                        <h1>CyberVault</h1>
                        <p class="sub">Welcome to CyberVault Moshe!</p>
                            ...
                            <% } %>
                                ...
                                <div class="links-container">
                                    <a href="https://apod.nasa.gov/apod/astropix.html" target="_blank"
                                        class="btn-link">✨ Explore NASA Astronomy Picture of the Day</a>
                                </div>
                    </div>
                    <% } %>
